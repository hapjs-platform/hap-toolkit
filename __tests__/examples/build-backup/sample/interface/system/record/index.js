...
/***/ "../../packages/hap-dsl-xvm/lib/loaders/style-loader.js?index=0&type=style!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=style!./src/interface/system/record/index.ux?uxType=page":
/*!*****************************************************************************************************************************************************************************************************************!*\
  !*** ../../packages/hap-dsl-xvm/lib/loaders/style-loader.js?index=0&type=style!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=style!./src/interface/system/record/index.ux?uxType=page ***!
  \*****************************************************************************************************************************************************************************************************************/
/***/ ((module) => {
...
/***/ "../../packages/hap-dsl-xvm/lib/loaders/template-loader.js!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=template!./src/interface/system/record/index.ux?uxType=page&":
/*!*****************************************************************************************************************************************************************************************************!*\
  !*** ../../packages/hap-dsl-xvm/lib/loaders/template-loader.js!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=template!./src/interface/system/record/index.ux?uxType=page& ***!
  \*****************************************************************************************************************************************************************************************************/
/***/ ((module) => {
          ...
          "children": [
            {
              "type": "text",
              "attr": {
                "value": function () {return '' + '录音文件路径: ' + (this.path)}
              }
            }
          ]
        },
          ...
          "children": [
            ...
            },
            {
              ...
              "attr": {
                ...
                "value": function () {return this.duration}
              },
              "events": {
                "change": function (evt) { return this.changeValue('duration',evt)}
              }
            }
          ]
        },
          ...
          "children": [
            ...
            },
            {
              ...
              "attr": {
                ...
                "value": function () {return this.sampleRate}
              },
              "events": {
                "change": function (evt) { return this.changeValue('sampleRate',evt)}
              }
            }
          ]
        },
          ...
          "children": [
            ...
            },
            {
              ...
              "attr": {
                ...
                "value": function () {return this.numberOfChannels}
              },
              "events": {
                "change": function (evt) { return this.changeValue('numberOfChannels',evt)}
              }
            }
          ]
        },
          ...
          "children": [
            ...
            },
            {
              ...
              "attr": {
                ...
                "value": function () {return this.encodeBitRate}
              },
              "events": {
                "change": function (evt) { return this.changeValue('encodeBitRate',evt)}
              }
            }
          ]
        },
        {
          ...
          "children": [
            ...
            },
            {
              ...
              "events": {
                "change": function (evt) { return this.changeValue('format',evt)}
              }
            }
          ]
        },
