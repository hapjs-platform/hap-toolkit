...
/***/ "../../packages/hap-dsl-xvm/lib/loaders/style-loader.js?index=0&type=style!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=style!./src/interface/system/image/index.ux?uxType=page":
/*!****************************************************************************************************************************************************************************************************************!*\
  !*** ../../packages/hap-dsl-xvm/lib/loaders/style-loader.js?index=0&type=style!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=style!./src/interface/system/image/index.ux?uxType=page ***!
  \****************************************************************************************************************************************************************************************************************/
/***/ ((module) => {
...
/***/ "../../packages/hap-dsl-xvm/lib/loaders/template-loader.js!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=template!./src/interface/system/image/index.ux?uxType=page&":
/*!****************************************************************************************************************************************************************************************************!*\
  !*** ../../packages/hap-dsl-xvm/lib/loaders/template-loader.js!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=template!./src/interface/system/image/index.ux?uxType=page& ***!
  \****************************************************************************************************************************************************************************************************/
/***/ ((module) => {
...
module.exports = {
  ...
  "children": [
          ...
          "children": [
            {
              ...
              "children": [
                ...
                },
                {
                  "type": "image",
                  "attr": {
                    "src": function () {return this.imageGetInfo.uri||''}
                  }
                },
                {
                  "type": "text",
                  "attr": {
                    "value": function () {return '' + 'uri: ' + (this.imageGetInfo.uri||'')}
                  },
                  "classList": [
                    "txt"
                  ]
                },
                {
                  "type": "text",
                  "attr": {
                    "value": function () {return '' + 'width: ' + (this.imageGetInfo.width||'')}
                  },
                  "classList": [
                    "txt"
                  ]
                },
                {
                  "type": "text",
                  "attr": {
                    "value": function () {return '' + 'height: ' + (this.imageGetInfo.height||'')}
                  },
                  "classList": [
                    "txt"
                  ]
                },
                {
                  "type": "text",
                  "attr": {
                    "value": function () {return '' + 'size: ' + (this.imageGetInfo.size||'')}
                  },
                  "classList": [
                    "txt"
                  ]
          ...
          "children": [
            {
              ...
              "children": [
                ...
                },
                {
                  "type": "image",
                  "attr": {
                    "src": function () {return this.imageCompressInfo.uri||''}
                  }
                },
                {
                  "type": "text",
                  "attr": {
                    "value": function () {return '' + 'uri: ' + (this.imageCompressInfo.uri||'')}
                  },
                  "classList": [
                    "txt"
                  ]
          ...
          "children": [
            {
              ...
              "children": [
                ...
                },
                {
                  "type": "image",
                  "attr": {
                    "src": function () {return this.imageOperateInfo.uri||''}
                  }
                },
                {
                  "type": "text",
                  "attr": {
                    "value": function () {return '' + 'uri: ' + (this.imageOperateInfo.uri||'')}
                  },
                  "classList": [
                    "txt"
                  ]
          ...
          "children": [
            {
              ...
              "children": [
                ...
                },
                {
                  "type": "image",
                  "attr": {
                    "src": function () {return this.imageEditInfo.uri||''}
                  }
                },
                {
                  "type": "text",
                  "attr": {
                    "value": function () {return '' + 'uri: ' + (this.imageEditInfo.uri||'')}
                  },
                  "classList": [
                    "txt"
                  ]
    ...
    },
    {
      "type": "div",
      "attr": {},
      "shown": function () {return this.showMask},
      "classList": [
        "mask"
      ],
      "events": {
