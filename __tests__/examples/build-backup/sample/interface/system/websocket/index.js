...
/***/ "../../packages/hap-dsl-xvm/lib/loaders/style-loader.js?index=0&type=style!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=style!./src/interface/system/websocket/index.ux?uxType=page":
/*!********************************************************************************************************************************************************************************************************************!*\
  !*** ../../packages/hap-dsl-xvm/lib/loaders/style-loader.js?index=0&type=style!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=style!./src/interface/system/websocket/index.ux?uxType=page ***!
  \********************************************************************************************************************************************************************************************************************/
/***/ ((module) => {
...
/***/ "../../packages/hap-dsl-xvm/lib/loaders/template-loader.js!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=template!./src/interface/system/websocket/index.ux?uxType=page&":
/*!********************************************************************************************************************************************************************************************************!*\
  !*** ../../packages/hap-dsl-xvm/lib/loaders/template-loader.js!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=template!./src/interface/system/websocket/index.ux?uxType=page& ***!
  \********************************************************************************************************************************************************************************************************/
/***/ ((module) => {
      ...
      "children": [
        {
          ...
          "events": {
            "click": function (evt) { return this.create('websock1',false,evt)}
          }
        },
        {
          "type": "input",
          ...
          "events": {
            "click": function (evt) { return this.create('websock2',true,evt)}
          }
        },
        {
          "type": "input",
        ...
        },
        {
          ...
          "events": {
            "click": function (evt) { return this.send('websock1',evt)}
          }
        },
        {
          "type": "input",
          ...
          "events": {
            "click": function (evt) { return this.send('websock2',evt)}
          }
        },
        {
          "type": "input",
          ...
          "events": {
            "click": function (evt) { return this.close('websock1',evt)}
          }
        },
        {
          "type": "input",
          ...
          "events": {
            "click": function (evt) { return this.close('websock2',evt)}
          }
        }
      ]
    }
