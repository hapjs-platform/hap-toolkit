    ...
    var createPageHandler = function() {
        return (() => {
            var __webpack_modules__ = {
                ...
                "../../packages/hap-dsl-xvm/lib/loaders/style-loader.js?index=0&type=style!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=style!./src/interface/system/file/index.ux?uxType=page": module => {
                    module.exports = {
                        ".doc-page": {
                            flex: 1,
                ...
                "../../packages/hap-dsl-xvm/lib/loaders/template-loader.js!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=template!./src/interface/system/file/index.ux?uxType=page&": module => {
                    module.exports = {
                        type: "div",
                        attr: {},
                        classList: [ "doc-page" ],
                        children: [ {
                            ...
                            children: [ {
                                ...
                                children: [ {
                                    ...
                                    attr: {
                                        value: function() {
                                            return "" + "下载文件：" + this.fileDownloadData;
                                        }
                                    },
                                    classList: [ "txt" ]
                                } ]
                                ...
                                children: [ {
                                    ...
                                    attr: {
                                        value: function() {
                                            return "" + "移动文件到文件夹：" + this.fileMoveToFolderData;
                                        }
                                    },
                                    classList: [ "txt" ]
                                } ]
                                ...
                                children: [ {
                                    ...
                                    attr: {
                                        value: function() {
                                            return "" + "文件列表：" + this.fileGetListData;
                                        }
                                    },
                                    classList: [ "txt" ]
                                } ]
                                ...
                                children: [ {
                                    ...
                                    attr: {
                                        value: function() {
                                            return "" + "获取文件信息：" + this.fileGetData;
                                        }
                                    },
                                    classList: [ "txt" ]
                                } ]
                                ...
                                children: [ {
                                    ...
                                    attr: {
                                        value: function() {
                                            return "" + "文件删除：" + this.fileDeleteData;
                                        }
                                    },
                                    classList: [ "txt" ]
                                } ]
            ...
            (() => {
                var $app_script$ = __webpack_require__("../../packages/hap-dsl-xvm/lib/loaders/script-loader.js!../../packages/hap-packager/lib/loaders/module-loader.js!../../node_modules/babel-loader/lib/index.js?cwd=<project-root>&cacheDirectory&plugins[]=<CWD>/packages/hap-dsl-xvm/lib/loaders/babel-plugin-jsx.js&comments=false&configFile=<project-root>/babel.config.js!../../packages/hap-dsl-xvm/lib/loaders/access-loader.js!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=script!./src/interface/system/file/index.ux?uxType=page");
                $app_define$("@app-component/index", [], (function($app_require$, $app_exports$, $app_module$) {
                    $app_script$($app_module$, $app_exports$, $app_require$);
                    if ($app_exports$.__esModule && $app_exports$.default) {
                        $app_module$.exports = $app_exports$.default;
                    }
                    $app_module$.exports.template = __webpack_require__("../../packages/hap-dsl-xvm/lib/loaders/template-loader.js!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=template!./src/interface/system/file/index.ux?uxType=page&");
                    $app_module$.exports.style = __webpack_require__("../../packages/hap-dsl-xvm/lib/loaders/style-loader.js?index=0&type=style!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=style!./src/interface/system/file/index.ux?uxType=page");
                }));
