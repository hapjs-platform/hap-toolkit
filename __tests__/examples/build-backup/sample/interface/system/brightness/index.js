...
/***/ "../../packages/hap-dsl-xvm/lib/loaders/style-loader.js?index=0&type=style!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=style!./src/interface/system/brightness/index.ux?uxType=page":
/*!*********************************************************************************************************************************************************************************************************************!*\
  !*** ../../packages/hap-dsl-xvm/lib/loaders/style-loader.js?index=0&type=style!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=style!./src/interface/system/brightness/index.ux?uxType=page ***!
  \*********************************************************************************************************************************************************************************************************************/
/***/ ((module) => {
...
/***/ "../../packages/hap-dsl-xvm/lib/loaders/template-loader.js!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=template!./src/interface/system/brightness/index.ux?uxType=page&":
/*!*********************************************************************************************************************************************************************************************************!*\
  !*** ../../packages/hap-dsl-xvm/lib/loaders/template-loader.js!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=template!./src/interface/system/brightness/index.ux?uxType=page& ***!
  \*********************************************************************************************************************************************************************************************************/
/***/ ((module) => {
      ...
      "children": [
        {
          ...
          "children": [
            ...
            },
            {
              "type": "text",
              "attr": {
                "value": function () {return '' + '亮度设置状态：' + (this.status) + ' ' + (this.sliderValue)}
              }
            }
          ]
        },
          ...
          "children": [
            {
              "type": "text",
              "attr": {
                "value": function () {return '' + '屏幕亮度模式: ' + (this.mode)}
              }
            }
          ]
        },
    ...
    },
    {
      ...
      "children": [
          ...
          "children": [
            {
              "type": "text",
              "attr": {
                "value": function () {return '' + '模式设置状态： ' + (this.setModStatus)}
              }
            }
          ]
        },
        {
          ...
          "events": {
            "click": function (evt) { return this.setMode(0,evt)}
          }
        },
        {
          "type": "input",
          ...
          "events": {
            "click": function (evt) { return this.setMode(1,evt)}
          }
        }
      ]
    }
