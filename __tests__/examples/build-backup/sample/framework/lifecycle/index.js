...
/***/ "../../packages/hap-dsl-xvm/lib/loaders/style-loader.js?index=0&type=style!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=style!./src/framework/lifecycle/index.ux?uxType=page":
/*!*************************************************************************************************************************************************************************************************************!*\
  !*** ../../packages/hap-dsl-xvm/lib/loaders/style-loader.js?index=0&type=style!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=style!./src/framework/lifecycle/index.ux?uxType=page ***!
  \*************************************************************************************************************************************************************************************************************/
/***/ ((module) => {
...
/***/ "../../packages/hap-dsl-xvm/lib/loaders/template-loader.js!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=template!./src/framework/lifecycle/index.ux?uxType=page&":
/*!*************************************************************************************************************************************************************************************************!*\
  !*** ../../packages/hap-dsl-xvm/lib/loaders/template-loader.js!../../packages/hap-dsl-xvm/lib/loaders/fragment-loader.js?index=0&type=template!./src/framework/lifecycle/index.ux?uxType=page& ***!
  \*************************************************************************************************************************************************************************************************/
/***/ ((module) => {
      ...
      "children": [
        {
          ...
          "repeat": function () {return this.lifecycleList},
          "children": [
            {
              "type": "text",
              "attr": {
            ...
            },
            {
              "type": "text",
              "attr": {
                "value": function () {return '' + '触发时机: ' + (this.lifecycleObject[this.$item].desc)}
              },
              "classList": [
                "txt"
              ]
            },
            {
              "type": "text",
              "attr": {
                "value": function () {return '' + '触发次数: ' + (this.lifecycleObject[this.$item].count)}
              },
              "classList": [
                "txt"
              ]
            },
            {
              "type": "text",
              "attr": {
                "value": function () {return '' + '参数: ' + (this.lifecycleObject[this.$item].params)}
              },
              "classList": [
                "txt"
              ],
              "shown": function () {return this.lifecycleObject[this.$item].params}
            }
          ]
        }
      ]
      ...
      "children": [
        {
          ...
          "children": [
            ...
            },
            {
              "type": "text",
              "attr": {
                "value": function () {return '' + 'name: ' + (this.pageInfo.name)}
              }
            },
            {
              "type": "text",
              "attr": {
                "value": function () {return '' + 'path: ' + (this.pageInfo.path)}
              }
            },
            {
              "type": "text",
              "attr": {
                "value": function () {return '' + 'component: ' + (this.pageInfo.component)}
              }
            }
          ]
        }
